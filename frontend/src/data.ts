...
export async function getAccount(id: string) {
  return (await getAccounts()).find((account) => account.id.toString() === id)!
}

export async function getSellingAccounts() {
  return (await getAccounts()).filter((account) => account.status === 'On Sale')
}
  ...
  return [
    {
      ...
      thumbUrl: '/events/we-all-look-the-same-thumb.jpg',
      description:
        'Leslie Alexander is a Canadian entrepreneur and philanthropist. He is the founder and CEO of Alexander Enterprises, a multinational conglomerate that specializes in technology, finance, and real estate.',
      role: 'Admin',
      status: 'On Sale',
      date: 'May 20, 2024',
      platform: 'YouTube',
